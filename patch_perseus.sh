...
if [ ! -f "com.bilibili.blhx.m4399.apk" ]; then
    ...
    wget "https://www.dropbox.com/scl/fi/7ur76ey4nnmigbaq8xye2/com.bilibili.blhx.m4399.apk?rlkey=wk30478lmmiegfkkvz5d2qrp9&st=olododcx&dl=0" -O "com.bilibili.blhx.m4399.apk" -q
    echo "apk downloaded !"
